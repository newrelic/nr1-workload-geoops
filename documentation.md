...
<img src="assets/documentation-images/launcher.png" width="500px" />
2. Click on one of the **Get Started** buttons on the screen.  
<img src="assets/documentation-images/map-empty-state.png" width="500px" />
...
<img src="assets/documentation-images/create-a-map.png" width="500px" />
...
<img src="assets/documentation-images/define-locations.png" width="500px" />
	1. Click **Upload JSON file**
	2. Click **Choose a file** in the slide-out window that appears  
	<img src="assets/documentation-images/file-upload.png" width="500px" />
	...
	<img src="assets/documentation-images/review-data.png" width="500px" />
5. Map each of your locations to one or more entities, then click **View map**.  
<img src="assets/documentation-images/no-locations-mapped.png" width="500px" />
	...
	<img src="assets/documentation-images/locations-mapped.png" width="500px" />
6. You're done, you've just created your first map!

## Using your maps
### Overview of the map UI
<img src="assets/documentation-images/fresh-map-legend.png" />
...
<img src="assets/documentation-images/marker-popover.png" width="200px" />  
...
<img src="assets/documentation-images/detail-panel-legend.png" />
...
When you click on the "View all Maps" on any map page, you will be taken to a page which displays a visual grid of all of your maps with an option to edit them. To edit one of your maps, click on the settings icon next to the title of the map you'd like to edit.<img src="assets/documentation-images/all-maps.png" />

Once, clicked, a settings popover will appear which will offer you options for the following actions:  

<img src="assets/documentation-images/settings-popover.png" width="200px" />
...
3. **Delete markers**: Deletes the locations associated with the map, but does not delete the map itself.